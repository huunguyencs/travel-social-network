import { Container, makeStyles, Typography, Grid, TextField, Button, InputAdornment } from "@material-ui/core";
import { AccountCircle, Home, LockRounded } from "@material-ui/icons";
                ...
                <Grid container item xs={12} sm ={6} alignItems="center" direction="column" justify="space-between" className = {classes.right}>
                    ...
                    <div style ={{display: 'flex', flexDirection: 'column', maxWidth: 400, minWidth: 300}}>
                       ...
                       <TextField 
                        label="Username" 
                        margin="normal"
                        InputProps={{startAdornment: <InputAdornment position = "start"><AccountCircle></AccountCircle></InputAdornment>}}
                        ></TextField>
                       ...
                       <TextField
                        ...
                        label="Password" 
                        margin="normal"
                        InputProps={{startAdornment: <InputAdornment position = "start"><LockRounded></LockRounded></InputAdornment>}}
                        ></TextField>

                       <div style ={{height: 20}}></div>
                       <Button color='primary' variant="contained">
                            <a color ="#FFFFFF">Đăng nhập</a>
                       </Button>
                       <div style ={{height: 20}}></div>
                       <Button>
                            Tạo tài khoản mới
