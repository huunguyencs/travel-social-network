...
const rows = [
  createData('Hồ Hoàn Kiếm', 'Hà Nội', 1, 4.5),
  createData('Bảo Tàng Điêu Khắc Champa', 'Đà Nẵng', 1, 0),
  createData('Hồ Hoàn Kiếm', 'Hà Nội', 1, 4.5),
  createData('Hồ Hoàn Kiếm', 'Hà Nội', 1, 4.5),
  createData('Hồ Hoàn Kiếm', 'Hà Nội', 1, 4.5),
  createData('Bảo Tàng Điêu Khắc Champa', 'Đà Nẵng', 1, 0),
...
const headCells = [
  ...
  { id: 'provice', numeric: false, disablePadding: true, label: 'Tỉnh/ Thành phố' },
  { id: 'numReview', numeric: true, disablePadding: true, label: 'Số lượng đánh giá' },
  { id: 'star', numeric: true, disablePadding: true, label: 'Đánh giá' },
  { id: 'action', numeric: false, disablePadding: true, label: 'Chỉnh sửa' },
];
    ...
    >
      {numSelected > 0 ? (
        ...
        <Autocomplete
          ...
          freeSolo
          renderInput={(params) => (
            <TextField {...params} label="Tìm kiếm địa điểm du lịch" variant="outlined" />
          )}
        />
      )}
                      ...
                      .map((row, index) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <TableCell align="left">{row.provice}</TableCell>
                            <TableCell align="left">{row.numReview}</TableCell>
