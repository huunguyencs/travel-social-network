import {  Button,Card, CardContent, CardHeader, Popper, ClickAwayListener, 
          MenuList, MenuItem,Grid, Typography, CircularProgress, Backdrop, 
          Paper, IconButton, Modal, Avatar, Dialog, DialogActions, DialogContent, 
          DialogTitle, Stepper, Step, StepLabel, StepContent, makeStyles,
          Box, Tab, Tabs
...
import { MoreVert, LocationOnOutlined, Label, Delete, Edit, FlagOutlined } from "@material-ui/icons";
                    ...
                    <Grid container className={classes.container}>
                        ...
                        <Grid container className={classes.tourDetailContainer}>
                                    ...
                                    <div className={classes.tourLeftInfo}>
                                        ...
                                        <div className={classes.tourTime}>
                                            <div className={classes.timeItem}>
                                                <Typography className={classes.timeItemTitle} style={{color:"#63B191"}}>Điểm khởi hành</Typography>
                                                <div>
                                            ...
                                            <div className={classes.timeItem}>
                                                <Typography className={classes.timeItemTitle} style={{color:"#f44336"}}>Điểm kết thúc</Typography>
                                        ...
                                        <div style={{paddingBottom: 20, borderBottom: "1px solid #0000001f", minHeight: 70}}>
                                            <SeeMoreText variant="body1" maxText={300} text={tour.content} />
                                        </div>
                            ...
                            <Grid container className={classes.tourDates}>
                                <Grid item lg={9} md={8} sm={12} xs={12} className={classes.tourDatesLeft}>
                                ...
                                <Grid item lg={3} md={4} sm={12} xs={12} className={classes.tourDatesRight}>
