      ...
      <Grid container>
        <Grid item md={6} sm={12} xs={12}>
          <div style={{ overflowY: 'auto', height: '70vh' }}>
            ...
            >
              Chi tiết lịch trình ngày {convertDateToStr(tourDate.date)}
            </Typography>
            <div style={{ padding: 20 }}>
              <Typography>Mô tả: {tourDate.description}</Typography>
              <Typography>
                Chi phí: {new Intl.NumberFormat().format(tourDate.cost * 1000)}{' '}
                VND
              </Typography>
            </div>
          </div>
              ...
              <div className={classes.infoTour}>
                ...
                <Grid container>
                  <Grid item md={8} sm={12} xs={12} style={{ paddingLeft: 30 }}>
                    <Typography variant="body1">{tour.content}</Typography>
                  ...
                  >
                    <Fade in={detailDate}>
                      <DetailDateRef
                        ...
                        handleClose={handleCloseDetailDate}
                        joined={joined}
                      />
                    </Fade>
                  </Modal>
