                    ...
                    <Grid item md={6} sm={12} xs={12}>
                        <div className={classes.infoTour}>
                            <div className={classes.coverTitle}>
                                <Typography variant="h4" className={classes.title}>{createTour.name}</Typography>
                            </div>
                            <Grid container>
                        ...
                        <Grid container >
                            ...
                            <Grid item md={9} sm={12} xs={12}>
                                ...
                                >
                                    <Fade in={showDetailDate}>
                                        <EditDetailDateRef ref={refEditDetailDate} date={idx} tourDate={createTour.tour[idx]} handleClose={handleCloseDetailDate} />
                                    </Fade>
                                </Modal>
